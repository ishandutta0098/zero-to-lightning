...
# In this example we will use the RichProgressBar
# Lightning by default uses tqdm
from lightning.pytorch.callbacks import ModelSummary, RichProgressBar
...
# Define a custom theme for the RichProgressBar
...
trainer = pl.Trainer(
    ...
    callbacks=[
        ...
        rich_progress_bar,  # Pass the rich_progress_bar to the Trainer
    ],
    precision="16-mixed",
