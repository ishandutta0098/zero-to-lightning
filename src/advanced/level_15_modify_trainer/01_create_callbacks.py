...
class CustomValidationCallback(Callback):
    """
    This is a simple demonstration of creating a Custom Callback and
    passing it to the trainer.

    The Callback is used everytime the Validation starts and ends.
    You should be able to see it in the logs!
    """
...
trainer = pl.Trainer(
    ...
    callbacks=[
        ...
        CustomValidationCallback(),  # Pass the custom callback to the trainer
    ],
    precision="16-mixed",
